  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-mono text-7xl font-light tracking-tight text-foreground">404</h1>
        <p className="mt-4 text-sm text-muted-foreground">
          Página não encontrada. Sem drama.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Tente recarregar. Se persistir, é bug mesmo.
        </p>
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        toastOptions={{
          className:
            "!bg-foreground !text-background !border-0 !rounded-md !text-sm !font-normal",
        }}
      />
    </QueryClientProvider>
  );
